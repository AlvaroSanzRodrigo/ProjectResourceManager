...
class AddVideoData : AppCompatActivity() {
    ...
    private fun savePicture() {
        ...
        val video = listOf(Document(projectId, validatedTitle, videoPath, notes.text.toString(), listOf(""), description.text.toString(), Date(), DocumentTypes.VIDEO))
        println(video)
    ...
    private fun bindView(){
        ...
        title = findViewById(R.id.add_video_data_description_text)
